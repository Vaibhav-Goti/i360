            ...
            : this()
        {
            ...
            switch (ValueType)
            {
                ...
                case PropertyID.WhiteBalance:
                    IntValue = WhiteBalancevalues.GetValue(Value).IntValue;
                    DoubleValue = WhiteBalancevalues.GetValue(Value).DoubleValue;
                    break;
            ...
            : this()
        {
            ...
            switch (ValueType)
            {
                ...
                case PropertyID.ISO:
                    ...
                    break;
                case PropertyID.WhiteBalance:
                    StringValue = WhiteBalancevalues.GetValue(Value).StringValue;
                    DoubleValue = WhiteBalancevalues.GetValue(Value).DoubleValue;
                    break;
                case PropertyID.ColorTemperature:
