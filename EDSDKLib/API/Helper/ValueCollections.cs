...
namespace EOSDigital.API
{
    ...
    public abstract class ValueBase
    {
        ...
        public static CameraValue GetValue(double value, List<CameraValue> Values)
        {
            CameraValue[] sorted = Values.Distinct(new CameraValueComparer())
                                    .Where(t => t.IntValue != unchecked((int)0xFFFFFFFF) && t != TvValues.Auto && t != ISOValues.Auto && t != WhiteBalancevalues.Auto)
    ...
    /// <summary>
    /// Stores WhiteBalance Values and provides methods to get those values
    /// </summary>
    public sealed class WhiteBalancevalues : ValueBase
    {
        ...
        /// <summary>
        /// The WhiteBalance <see cref="CameraValue"/> of the "Auto" or "None" setting
        /// </summary>
        public static readonly CameraValue Auto = new CameraValue("Auto", 0, 0, PropertyID.WhiteBalance);
        /// <summary>
        /// The WhiteBalance <see cref="CameraValue"/> of an invalid setting
        /// </summary>
        public static readonly CameraValue Invalid = new CameraValue("N/A", unchecked((int)0xFFFFFFFF), 0, PropertyID.WhiteBalance);
        ...
        static WhiteBalancevalues()
        {
            ...
            {
                Auto,
                new CameraValue("Pasted", -2, 0, PropertyID.WhiteBalance),
                new CameraValue("Click", -1, 0, PropertyID.WhiteBalance),
                new CameraValue("Auto", 0, 0, PropertyID.WhiteBalance),
                new CameraValue("Daylight",  1, 0, PropertyID.WhiteBalance),
                new CameraValue("Cloudy", 2, 0, PropertyID.WhiteBalance),
                new CameraValue("Tangsten", 3, 0, PropertyID.WhiteBalance),
                new CameraValue("Fluorescent", 4, 0, PropertyID.WhiteBalance),
                new CameraValue("Strobe", 5, 0, PropertyID.WhiteBalance),
                new CameraValue("WhitePaper", 6, 0, PropertyID.WhiteBalance),
                new CameraValue("Shade", 8, 0, PropertyID.WhiteBalance),
                new CameraValue("ColorTemperature", 9, 0, PropertyID.WhiteBalance),
                Invalid
            };
        }
